...
asmatkable <- kbl(res, booktabs=TRUE, digits=3, caption="Table 4: Model 1", align = "c") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
...
Test for significance of difference in segregation based on Model 1. 
...
Time heterogeneity, Based on Model 1
...
asmatkable <- kbl(res, booktabs=TRUE, digits=3, caption="Table 4: Model 4", align = "c") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  column_spec(column = 1, width = "3in")   %>%
  #row_spec(c(11, 24,41), bold = T, color = "white", background = "#D7261E") %>%
